...
system(['scp ',...
    ...
    job_struct(order_inds(1),order_inds(2)).context_config.remote_user_name,'@', ...
    job_struct(order_inds(1),order_inds(2)).context_config.remote_exec_host,':',job_struct(order_inds(1),order_inds(2)).remote_log]);
